    ...
    <main className="min-h-screen overflow-x-hidden bg-[#f3f3f3] text-[#121826]">
      ...
      <section className="px-3 py-3 sm:px-5 sm:py-5">
        <div className="mx-auto min-h-[calc(100vh-24px)] max-w-[1500px] overflow-hidden rounded-[2rem] bg-white shadow-[0_24px_80px_rgba(15,23,42,.10)] sm:min-h-[calc(100vh-40px)]">
          ...
          <div className="flex min-h-[790px] flex-col">
            <div className="order-1 flex min-h-[680px] items-center justify-center border-b border-slate-200 bg-gradient-to-br from-white via-white to-violet-50 px-4 py-10 sm:px-8 lg:px-12">
            ...
            <div className="order-2 flex flex-col items-center justify-center px-6 py-14 text-center sm:px-10 lg:px-16 lg:py-20">
              <p className="mb-4 text-xs font-black uppercase tracking-[0.26em] text-orange-600">Private AI tools for creators</p>
              <h1 className="mx-auto max-w-2xl text-5xl font-black uppercase leading-[.94] tracking-[-0.055em] text-slate-950 sm:text-6xl xl:text-7xl">
              ...
              >
                ...
                <div className="border-t border-white/10 bg-black/25 px-3 py-2.5">
