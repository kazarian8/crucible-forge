...
export const metadata: Metadata = {
  title: "Crucible — Refine. Repair. Reforge.",
  description:
    "Powerful AI furnaces for audio, prompts, code, image restoration, and creative production.",
};
    ...
    <main className="site-shell">
      <header className="topbar">
        <div className="nav-wrap">
          ...
          <div className="nav-actions">
            ...
            <Link href="/signup" className="btn btn-fire small">
              Start Free Month
            </Link>
          </div>
        </div>
      ...
      <section className="hero">
        ...
        <div className="hero-copy">
          ...
          <p className="hero-subtitle">
            AI furnaces that refine audio, code, prompts, images, and more.
          </p>
        ...
        <div className="hero-art" aria-label="Crucible molten emblem">
          <div className="logo-aura" />
          <Image
            src="/crucible-logo.png"
            alt="Golden Crucible emblem with molten fire"
            width={760}
            height={760}
            className="hero-logo"
            priority
      ...
      <style jsx>{`
        ...
        .hero-art::before {
          ...
          border-radius: 50%;
          background:
            radial-gradient(circle, rgba(255, 112, 0, 0.26) 0%, rgba(255, 64, 0, 0.08) 42%, transparent 70%);
          filter: blur(12px);
        }
        ...
        .hero-art::after {
          ...
          height: 12%;
          border-radius: 50%;
          background: radial-gradient(ellipse, rgba(255, 88, 0, 0.46), transparent 72%);
          filter: blur(17px);
        }
        ...
        .hero-logo {
          ...
          object-fit: contain;
          filter:
            drop-shadow(0 0 16px rgba(255, 135, 19, 0.34))
        ...
        .logo-aura {
          ...
          border-radius: 50%;
          background:
            conic-gradient(from 30deg, transparent, rgba(255, 107, 0, 0.28), transparent 40%, rgba(255, 188, 61, 0.19), transparent);
          filter: blur(35px);
