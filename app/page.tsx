  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#050505] text-white">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 sm:py-4">
          <Link href="/" className="flex items-center gap-3">
            <span
              aria-hidden="true"
              className="relative grid h-11 w-11 place-items-center overflow-hidden rounded-full bg-gradient-to-br from-amber-300 via-orange-500 to-red-600 shadow-[0_0_34px_rgba(249,115,22,.48)]"
            >
              <span className="absolute bottom-[8px] h-5 w-4 rotate-45 rounded-[60%_40%_65%_35%] bg-black/90" />
              <span className="absolute bottom-[11px] h-3.5 w-2.5 rotate-45 rounded-[60%_40%_65%_35%] bg-orange-300" />
              <span className="absolute bottom-[7px] h-1.5 w-6 rounded-full bg-black/90" />
            </span>
            <span>
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10">
        ...
        <div className="mx-auto flex min-h-[650px] max-w-7xl items-start px-4 pb-16 pt-16 sm:min-h-[760px] sm:items-center sm:px-6 sm:py-24 lg:py-28">
          <div className="mx-auto max-w-3xl text-center lg:mx-0 lg:max-w-2xl lg:text-left">
            ...
            <h1 className="mt-5 text-[3.15rem] font-black leading-[0.9] tracking-[-0.055em] sm:mt-6 sm:text-7xl lg:text-8xl">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-white/72 sm:mt-6 sm:text-lg sm:leading-8 lg:mx-0">
            ...
            <div className="mt-6 grid gap-3 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              <Link
                href="/signup"
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-x-6 gap-y-3 text-sm font-semibold text-white/70 lg:justify-start">
              <span>✓ $0 today with payment method</span>
              <span>✓ 30 days of member access</span>
              <span>✓ Then $19.99/month unless canceled</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-white/10 bg-[#080808] px-4 py-20 sm:px-6">
        <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[1.15fr_.85fr]">
          <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-7 sm:p-10">
            ...
            <h2 className="mt-4 text-4xl font-black">$0 today. Full access for 30 days.</h2>
            <p className="mt-5 max-w-2xl leading-8 text-white/60">
              A valid payment method is required to begin the free month.
              You pay $0 today and receive 30 days of member access. After the
              trial, membership renews at $19.99 per month unless canceled before
              renewal. Premium exports, larger jobs, advanced retries, and
              third-party processing may still require credits or separate payment.
            </p>
            ...
            <p className="mt-4 max-w-2xl text-xs leading-5 text-white/38">
              Valid payment method required. $0 due today. After 30 days,
              membership automatically renews at $19.99/month unless canceled.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-black p-7 sm:p-10">
            ...
            <h3 className="mt-4 text-3xl font-black">$0 today. Then $19.99/month.</h3>
            <div className="mt-6 space-y-4 text-sm leading-6 text-white/62">
              <p>✓ Add a valid payment method to begin.</p>
              <p>✓ Unlock active furnaces during your 30-day trial.</p>
              <p>✓ See all premium pricing before any paid action.</p>
              <p>✓ Cancel before renewal to avoid the monthly charge.</p>
            </div>
          </div>
        </div>
      </section>
