...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      {/* Blurred image fills unused space */}
      <div
      ...
      <div className="relative flex min-h-screen items-center justify-center">
        <div
          className={`relative h-screen w-full max-w-[1536px] overflow-hidden transition duration-[700ms] ease-in-out ${
            isEntering ? "scale-[1.22] opacity-0" : "scale-100 opacity-100"
          }`}
        >
          <img
          ...
          >
            <span
              className={`absolute inset-0 rounded-sm border transition duration-300 ${
                isEntering
                  ? "border-orange-200 bg-orange-500/40 shadow-[0_0_80px_rgba(249,115,22,.9)]"
      ...
      {/* Short transition flash */}
      <div
        className={`pointer-events-none fixed inset-0 z-50 bg-orange-100 transition duration-500 ${
