  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#050505] text-white">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
          <Link href="/" className="flex items-center gap-3" aria-label="Crucible home">
            <span className="relative h-12 w-12 shrink-0 overflow-hidden rounded-xl border border-orange-400/25 bg-black shadow-[0_0_30px_rgba(249,115,22,.38)] sm:h-14 sm:w-14">
              <img
                src="/crucible-logo.png"
                alt="Crucible molten forge logo"
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10">
        ...
        <div className="mx-auto flex min-h-[650px] max-w-7xl items-start px-4 pb-16 pt-12 sm:min-h-[760px] sm:items-center sm:px-6 sm:py-24 lg:py-28">
