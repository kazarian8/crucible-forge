    ...
    <main className="site-shell">
      ...
      <section className="hero">
        ...
        <div className="hero-copy">
          ...
          <div className="hero-action-row">
            <Link
              href="/signup"
              className="btn btn-fire hero-cta"
              style={{
                display: "flex",
                width: "100%",
                minHeight: "60px",
                ...
                color: "#ffffff",
                background:
                  "linear-gradient(180deg, #ffb52e 0%, #ff7200 48%, #d94100 100%)",
                boxShadow:
                  "0 0 18px rgba(255,116,0,.9), 0 0 45px rgba(255,70,0,.45), inset 0 1px 0 rgba(255,255,255,.65)",
                fontWeight: 900,
                letterSpacing: ".055em",
            ...
            <div className="signup-perks">
              <strong>5,000 FREE FORGE CREDITS</strong>
          ...
          <div className="capability-strip" aria-label="Crucible capabilities">
            <span>Audio</span>
            <span>Images</span>
            <span>Code</span>
            <span>Video</span>
      ...
      <style jsx>{`
        ...
        .signup-perks strong {
          ...
          font-size: 0.82rem;
          letter-spacing: 0.08em;
          text-shadow: 0 0 12px rgba(255, 103, 0, 0.45);
        }
        ...
        .capability-strip span {
          padding: 6px 10px;
          border: 1px solid rgba(255, 136, 24, 0.32);
          border-radius: 999px;
          color: #d7c4ab;
