...
const distributionPlatforms = [
  "Spotify", "Apple", "YouTube", "Amazon", "TikTok", "Instagram", "Facebook", "Pandora",
  "Deezer", "Tidal", "SoundCloud", "iHeart", "Napster", "Boomplay", "Tencent", "NetEase",
  "Anghami", "Claro", "JioSaavn", "Gaana", "Shazam", "Audiomack", "Qobuz", "KKBOX",
  "Triller", "Snap", "CapCut", "Peloton", "MediaNet", "Beatport", "Joox", "Yandex",
  "AWA", "Kuack", "Adaptr", "Flo", "TouchTunes", "Mixcloud", "Resso", "7digital",
];
    ...
    <main className="min-h-screen overflow-x-hidden bg-[#f3f3f3] text-[#121826]">
      ...
      <section className="px-3 py-3 sm:px-5 sm:py-5">
        <div className="mx-auto min-h-[calc(100vh-24px)] max-w-[1500px] overflow-hidden rounded-[2rem] bg-white shadow-[0_24px_80px_rgba(15,23,42,.10)] sm:min-h-[calc(100vh-40px)]">
          <header className="flex items-center justify-between gap-5 px-5 py-5 sm:px-9 lg:px-12">
            <a href="/" className="group flex items-center gap-3" aria-label="Crucible home">
              ...
              <span>
                <span className="block text-2xl font-black tracking-[0.09em] text-slate-950 sm:text-3xl">CRUCIBLE</span>
                <span className="block text-[9px] font-black uppercase tracking-[0.28em] text-orange-600">Refine. Repair. Reforge.</span>
              </span>
            </a>
          ...
          <div className="grid lg:min-h-[790px] lg:grid-cols-2">
            <div className="flex flex-col justify-center border-b border-slate-200 px-6 py-10 sm:px-10 lg:border-b-0 lg:border-r lg:px-16 lg:py-14">
              <p className="mb-4 text-xs font-black uppercase tracking-[0.26em] text-orange-600">Private AI tools for creators</p>
              <h1 className="max-w-2xl text-5xl font-black uppercase leading-[.94] tracking-[-0.055em] text-slate-950 sm:text-6xl xl:text-7xl">
                Everything<br />enters raw.<br />
                <span className="text-orange-600">Everything<br />leaves reforged.</span>
              </h1>
              ...
              <a
                ...
                className="group mt-8 block overflow-hidden rounded-[1.35rem] border border-lime-400 bg-[#0b1220] text-white transition hover:-translate-y-1"
                ...
                <div className="flex items-center gap-4 px-5 py-5 sm:px-6">
                  <div className="flex min-w-0 flex-1 items-center gap-4">
                    ...
                    <div className="min-w-0 border-l border-white/25 pl-4">
                      ...
                      <p className="mt-1 text-xl font-black uppercase leading-tight sm:text-2xl">Finished the track?</p>
                  ...
                  <div className="grid grid-cols-8 gap-2 sm:grid-cols-10">
                    {distributionPlatforms.map((platform) => (
                      <span
                        ...
                        title={platform}
                        aria-label={platform}
                        className="flex aspect-square items-center justify-center rounded-lg border border-white/10 bg-white/[0.07] px-1 text-center text-[8px] font-black leading-none text-white/90 transition group-hover:border-lime-300/40 group-hover:bg-lime-300/10"
                      >
                        {platform.slice(0, 2).toUpperCase()}
                      </span>
                    ))}
                  </div>
                  <p className="mt-3 text-center text-[10px] font-bold uppercase tracking-[0.16em] text-white/45">40 major platforms shown • 150+ stores and services available</p>
                </div>
              </a>
            ...
            <div className="flex items-center justify-center bg-gradient-to-br from-white via-white to-violet-50 px-6 py-10 sm:px-10 lg:px-14">
              <div className="w-full max-w-xl">
                <div className="text-center">
                  <p className="text-sm font-black uppercase tracking-[0.22em] text-violet-700">Create your account</p>
                  <h2 className="mt-2 text-3xl font-black text-slate-950 sm:text-4xl">Start your free month.</h2>
                  <p className="mt-2 text-slate-500">Cancel anytime before renewal.</p>
                </div>
                ...
                <form action="/signup" method="get" className="mt-8 space-y-3">
                  ...
                  <button type="submit" className="flex min-h-16 w-full items-center justify-center rounded-xl bg-gradient-to-r from-violet-700 to-indigo-600 px-6 text-base font-black uppercase tracking-[0.05em] text-white shadow-[0_14px_35px_rgba(109,40,217,.28)] transition hover:brightness-110">
                    Start Your Free Month <span className="ml-3 text-2xl">→</span>
                  </button>
                </form>

                <p className="mt-4 text-center text-sm font-semibold text-slate-500">$0 today • Includes <span className="text-violet-700">5,000 credits</span> • Then <span className="text-violet-700">$19.99/month</span></p>
