        ...
        <div className="mx-auto min-h-[calc(100vh-24px)] max-w-[1500px] overflow-hidden rounded-[2rem] bg-white shadow-[0_24px_80px_rgba(15,23,42,.10)] sm:min-h-[calc(100vh-40px)]">
          <header className="flex items-center justify-between gap-3 px-4 py-4 sm:px-9 sm:py-5 lg:px-12">
            <a href="/" className="group flex items-center gap-3" aria-label="Crucible home">
              ...
              <span>
                <span className="font-display block text-2xl tracking-[0.09em] text-slate-950 sm:text-4xl">CRUCIBLE</span>
          ...
          <div className="grid lg:min-h-[790px] lg:grid-cols-2">
            <div className="order-2 flex min-w-0 flex-col justify-center border-b border-slate-200 px-5 py-10 sm:px-10 lg:order-1 lg:border-b-0 lg:border-r lg:px-16 lg:py-14">
              ...
              <h1 className="font-display max-w-full break-words text-[3.15rem] uppercase leading-[.9] text-slate-950 sm:max-w-2xl sm:text-7xl xl:text-8xl">
              ...
              <div className="w-full max-w-xl py-2 sm:py-0">
                <div className="mb-7 text-center">
                  <p className="text-sm font-black uppercase tracking-[0.22em] text-orange-600">
                    Build it. Fix it. Finish it. Release it.
                  </p>
                  <h2 className="mx-auto mt-3 max-w-xl text-3xl font-black leading-tight text-slate-950 sm:text-4xl">
                    Everything creators need in one private furnace.
                  </h2>
                  <p className="mx-auto mt-4 max-w-xl text-base leading-7 text-slate-600">
                    Crucible gives creators private tools for music mastering, AI video prompts, code repair, artwork, and release preparation—all in one place.
                  </p>
                </div>

                <div className="text-center">
                  <p className="text-sm font-black uppercase tracking-[0.22em] text-violet-700">Create your account today</p>
                  <h2 className="font-display mt-2 text-4xl uppercase leading-[.95] text-slate-950 sm:text-5xl">
                ...
                <form action="/signup" method="get" className="mt-8 space-y-3">
                  ...
                  <button type="submit" className="font-display flex min-h-16 w-full items-center justify-center rounded-xl bg-gradient-to-r from-violet-700 to-indigo-600 px-6 text-xl uppercase tracking-[0.06em] text-white shadow-[0_14px_35px_rgba(109,40,217,.28)] transition hover:brightness-110">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
            <div>
              ...
              <h2 className="font-display mt-4 text-5xl uppercase leading-none sm:text-6xl">Premium unlocks it. Credits power it.</h2>
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="font-display mt-4 text-5xl uppercase leading-none sm:text-6xl">
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <div className="mt-12 rounded-3xl border border-orange-500/30 bg-gradient-to-r from-orange-500/10 to-amber-500/5 p-8 text-center shadow-2xl sm:p-12">
            ...
            <h3 className="font-display mt-3 text-4xl uppercase leading-none sm:text-5xl">
